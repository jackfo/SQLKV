...
public class ParserImpl{
    ...
    public Visitable parseStatement(String sql) throws ParseException, StandardException {
     ...
     * */
    public Visitable parseStatement(String statementSQLText, Object[] paramDefaults) throws ParseException, StandardException {
       return parseStatement(statementSQLText,paramDefaults,true);
    }

    private Visitable parseStatement(String sql, Object[] paramDefaults, boolean isStatement) throws ParseException, StandardException {
