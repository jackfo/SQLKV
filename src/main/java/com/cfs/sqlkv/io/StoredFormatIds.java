...
public interface StoredFormatIds {
    ...
    /**
     class  .NationalCharTypeId
     */
    //static public final int NATIONAL_CHAR_TYPE_ID =
    //(MIN_ID_2 + 370);

    /**
     class  .NationalLongvarcharTypeId
     */
